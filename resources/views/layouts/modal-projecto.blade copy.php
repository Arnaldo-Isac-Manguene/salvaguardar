                    ...
                    <div class="container-fluid">
                        ...
                        <div class="mb-3">
                            ...
                            {{-- @foreach ($funcionarios as $funcionario) --}}
                                {{-- <option onclick="buscarID_preparador('{{ //$funcionario->id }}')" value="{{ $funcionario->nome }}">{{ $funcionario->nome }}</option> --}}
                            {{-- @endforeach --}}
                            </select>
                            ...
                            >
                                <option selected>selecione</option>
                                @foreach ($funcionarios as $funcionario)
                                    <option onclick="buscarID_aprovador('{{ $funcionario->id }}')" value="{{ $funcionario->nome }}">{{ $funcionario->nome }}</option>
                                @endforeach
                            </select>
